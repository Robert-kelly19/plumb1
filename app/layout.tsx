...
{/* Navigation */}
            ...
            <div className="flex justify-between items-center h-16 sm:h-20 transition-all duration-300" id="nav-content">
              ...
              <div className="shrink-0">
                <Link href="/" className="flex items-center gap-2 sm:gap-3 group">
                  <div className="w-9 h-9 sm:w-10 lg:w-12 bg-gradient-to-br from-accent to-accent-light rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-105 transition-all duration-300">
        ...
        <footer className="footer">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Emergency Banner */}
            <div className="mt-10 sm:mt-12 bg-gradient-to-r from-accent/20 to-transparent rounded-2xl p-5 sm:p-6 md:p-8 border border-accent/20">

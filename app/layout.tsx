  ...
  return (
    <html lang="en">
      ...
      <body className="antialiased font-body">
        {/* Top Contact Bar */}
        <div className="bg-primary-dark text-white py-2 px-4 hidden lg:block">
          <div className="max-w-7xl mx-auto flex justify-between items-center text-sm">
            <div className="flex items-center gap-6">
              <a href="tel:02079460123" className="flex items-center gap-2 hover:text-accent transition-colors">
            ...
            <div className="flex justify-between items-center h-20 transition-all duration-300" id="nav-content">
              ...
              <div className="shrink-0">
                <Link href="/" className="flex items-center gap-3 group">
                  <div className="w-12 h-12 bg-gradient-to-br from-accent to-accent-light rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl group-hover:scale-105 transition-all duration-300">
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                    </svg>
                  </div>
                  <div className="hidden sm:block">
                    <span className="text-xl font-bold text-primary">Rapid</span>
                    <span className="text-xl font-bold text-accent">Plumbing</span>
                  </div>
                </Link>
              </div>
              ...
              <div className="hidden md:flex items-center gap-1">
                <Link href="/" className="nav-link px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors">
                  Home
                </Link>
                <Link href="/services" className="nav-link px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors">
                  Services
                </Link>
                <Link href="/contact" className="nav-link px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors">
                  Contact
                </Link>
              </div>
              ...
              <div className="md:hidden flex items-center gap-3">
                <a href="tel:02079460123" className="w-10 h-10 bg-primary/5 rounded-full flex items-center justify-center hover:bg-primary/10 transition-colors">
                  <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </a>
                <button className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center hover:bg-primary-light transition-colors" id="mobile-menu-btn">
        ...
        <footer className="footer">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Emergency Banner */}
            <div className="mt-12 bg-gradient-to-r from-accent/20 to-transparent rounded-2xl p-6 border border-accent/20">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-accent rounded-xl flex items-center justify-center animate-pulse-glow">
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className="text-white font-semibold text-lg">Plumbing Emergency?</h4>
                    <p className="text-gray-400 text-sm">We're available 24/7 for urgent plumbing issues</p>
                  </div>
                </div>
                <a href="tel:02079460123" className="btn btn-primary whitespace-nowrap">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
